...
from  DRP.reduction import coarse_regis
from DRP.mask_design.wircpol_masks import * ### Make sure that the wircpol/DRP/mask_design directory is in your Python Path!
