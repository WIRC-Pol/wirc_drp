...
wircpol_dir = '/'.join(os.path.realpath(__file__).split('/')[:-1]) #Get path to the constant.py script
...
trace_template = np.load(wircpol_dir+'/specification/trace_template.npy')
